...
// import { addRoomToCart } from "../../features/cart/cartSlice";
...
//         description: "The Family Room, with its king-sized bed and high-quality linens, ensures a restful sleep. It includes a modern bathroom, a seating area, and a flat-screen TV. Complimentary Wi-Fi, a stocked mini-bar, and a safe are also provided. Large windows offer city views. Guests have access to 24-hour room service. This room is a blend of comfort and luxury, perfect for both business and leisure stays.",
//         totalRoom: 8,
//         imageUrl: "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&q=80&w=2874&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
//         amenityIds: [
//             1,
...
//   const startDate = dayjs(searchData?.checkIn);
//   const endDate = dayjs(searchData?.checkOut);
//   const totalNight = endDate.diff(startDate,"day");

//   const onFinish = (roomValues) => {
//     const cartValue = {
//       type: roomValues.selectedRoom.name,
//       pricePerNight: roomValues.selectedRoom.pricePerNight,
//       quantity: parseInt(roomValues.selectedAmount)
//     }
//     dispatch(addRoomToCart(cartValue))
//   };


//   const onValuesChange = (changedValues, allValues) => {
//     console.log(allValues);
//     setRoomTypes(allValues);
//     const changedKey = Object.keys(changedValues)[0];
//     const changedValue = changedValues[changedKey];
    
//     const selectedRoom = rooms.find(room => room.type.name === changedKey);

//     const selectedData = {
//       selectedRoom: selectedRoom.type,
//       selectedAmount : changedValue
//     }
    
//     onFinish(selectedData);
//   }

//   const disableOptions = (room,roomType) => {
//     const typeArr = Object.keys(roomTypes); //[ "Deluxe Single", "Deluxe Double", "Family Double" ]
//     const roomArr = Object.values(roomTypes);// [2,0,0]
...
//           initialValues={Object.fromEntries(rooms.map(room => [room.type.name,0]))} >
//           {
//             rooms?.map((room) => {
//               const roomsList = roomsArray(room.available);
//               return (
