...
const Rules = () => {
  return (
    <section>
        <p className="lg:text-2xl text-xl font-bold text-gray-100 font-serif mt-5 lg:mb-4 mb-2">Hotel Rules</p>
        <p className="lg:text-xl md:text-base text-gray-50 mb-6">Nextel Mandalay takes special requests:</p>
...
const Rule = ({icon, title, content, border}) => {
    return <div className={`lg:py-6 md:py-3 flex items-start gap-6 ${border ? "border-b border-[#D9D9D9] " : ""} `}>
